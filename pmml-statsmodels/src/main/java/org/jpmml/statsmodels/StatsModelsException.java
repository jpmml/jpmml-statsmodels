...
public class StatsModelsException extends ConversionException {

	public StatsModelsException(String message){
		super(message);
	}

	public StatsModelsException(String message, Throwable cause){
		super(message, cause);
	}
}